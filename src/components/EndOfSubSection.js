  ...
  return (
    <PagesContext.Consumer>
      {(value) => {
        ...
        // Generate language-aware path for next part
        const nextPath = nextPart ? getLanguagePath(nextPart.path) : null
